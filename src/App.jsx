...
import FibStuff from './pages/FibStuff';
...
function App() {
  ...
  const getBasename = () => {
    ...
    const knownRoutes = ['trading', 'notes', 'projection', 'settings', 'calendar', 'dashboard', 'fib-stuff', 'budget-tracker', 'miner', 'api-monitor', 'trading-bot', 'login', 'register', 'admin'];
        ...
        <BrowserRouter basename={basename}>
          ...
          <Routes>
            ...
            <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
              ...
              <Route path="fib-stuff" element={<FibStuff />} />
