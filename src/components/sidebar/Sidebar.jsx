...
const PAGE_ICONS = {
  ...
  '/cme': (
    <svg className={ICON_CLASS} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8h-8m-2 10v2m0-2v-2m0 2h-2m2 0h2m-2-4v2m0-2v-2m0 2h-2m2 0h2m-2-4v2m0-2v-2m0 2h-2m2 0h2" />
    </svg>
  ),
  '/budget-tracker': (
    <svg className={ICON_CLASS} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
function getDefaultSections() {
  return [
    ...
    { id: 'markets', label: 'Markets', pagePaths: ['/trading-bot', '/sentiment', '/cme', '/trading'] },
