 ...
 * @param block_height Block height (e.g. from getblocktemplate)
 * @param pos Output clock position (ring=0, position=block_height mod 12)
 * @param magnitude_out If non-NULL, set to block_height/12 for use with clock_generate_prime_o1
 * @return MATH_SUCCESS
 *
 * Used with clock_generate_prime_o1 for O(1) seed prime when position is 3,6,9.
 * Caller should fall back to SFT when clock_generate_prime_o1 returns 0.
 */
